...
export async function GET(
  ...
  try {
    ...
    // Create Swiss QR Bill as SVG using official library with correct options
    const swissQRBill = new SwissQRBill(qrBillData, {
      language: qrLanguage,
      outlines: false,  // Remove additional outlines
      scissors: false,  // Don't add scissors inside the SVG
    })
