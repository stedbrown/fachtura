-- ============================================
-- FIX: Set immutable search_path for check_subscription_limits
...
COMMENT ON FUNCTION public.check_subscription_limits(UUID, TEXT) IS 
  'Check subscription limits for all resource types. SECURITY: search_path fixed to prevent injection.';
