-- ============================================
-- UPDATE check_subscription_limits FUNCTION
-- Add support for 'product' and 'order' resource types
-- ============================================
...
COMMENT ON FUNCTION check_subscription_limits(UUID, TEXT) IS 
  'Check subscription limits for invoice, quote, client, product, and order resources. Products counted as total (like clients), orders counted monthly.';
